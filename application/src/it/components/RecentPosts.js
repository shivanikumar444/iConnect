...
/*
    displays a list view with top ten posts which has recent activities
...
export default class  RecentPosts extends Component {
  ...
  componentDidMount(){
    fetch(this.JIVE_API_URI+'places/1997/contents?sort=latestActivityDesc',{
      method: 'GET',
      headers: {
  ...
  rowPressed(rowData) {
    ...
    this.props.navigator.push({
      route: 'post-view',
      passProps: {auth: this.props.auth, uri: rowData.resources.html.ref, usrName: this.state.usrName, usrAvatar: this.state.usrAvatar, designation: this.state.designation, title: 'IT'}
    });
  }
    ...
    if(this.state.loading){
      return(
        <View style={styles.container}>
          <Header navigator={this.props.navigator} title={'IT'} />
          <View style={styles.separator}/>
