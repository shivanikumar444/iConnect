...
import DayLogList from '../dayTrack/DayView';

var deviceWidth = Dimensions.get('window').width;
var deviceHeight = Dimensions.get('window').height;

export default class WeekDayLog extends Component {
  constructor(props){
    super(props);
    this.state = {
      /* SideMenu */
      ...
      .then((userDetails) => {
        ...
        switch(userDetails.tab) {
          case 'B' :
            ...
            break;
          case 'W' :
            this.props.navigator.replace({route: 'show-weeks', passProps: {auth: this.props.auth}});
            break;
          case 'D' :
      ...
      <View style={styles.body}>
          ...
          <View>
            <TouchableHighlight style={styles.button} onPress={this.onDayLogList.bind(this)} underlayColor='#99d9f4'>
              <Text style={styles.buttonTxt}> View/Edit Log </Text>
            </TouchableHighlight>
          </View>
          ...
          <View>
            <TouchableHighlight style={styles.button} onPress={this.onWeeksList.bind(this)} underlayColor='#99d9f4'>
              <Text style={styles.buttonTxt}> Weekly Task List </Text>
            </TouchableHighlight>
          </View>
        </View>
