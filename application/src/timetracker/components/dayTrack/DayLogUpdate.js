...
export default class DayLogUpdate extends Component {
  TIME_TRACK_BASE_URI = '';
  constructor(props) {
        super(props);
    ...
    componentWillMount() {
      ...
      /* List props */
      console.log("Props = "+ JSON.stringify(this.props.reqData));
      if (this.props.reqData != "") {
        this.setState({
          textInputValue: this.props.reqData.project_name.toString(),
          textInputId: this.props.reqData.project_id.toString(),
          taskInputValue: this.props.reqData.task_name,
          // taskInputId: this.props.reqData.task_id.toString(),
          taskInputId: this.taskData(this.props.reqData.task_name),
          todayDate: new Date(this.props.reqData.date).toJSON().slice(0,10),
          textHrsValue: this.props.reqData.hours.toString(),
          textMinValue: this.props.reqData.minutes.toString(),
          textFieldValue: this.props.reqData.description.toString(),
          track_id: this.props.reqData.track_id.toString(),
        })
      }
      /*  List props  */
    }
  ...
  onSubmit(){
    ...
    console.log("Project Name = " + this.state.textInputValue +
      ...
      var url = {
        date: this.getDateFormat(this.state.todayDate).toString(),
        ...
        <View style={{flexDirection: 'column', height: (0.65 * deviceHeight), margin: 10}}>
          ...
          <View style={{paddingTop: 20, flexDirection: 'row'}}>
            <View style={{marginTop:10}}>
              <Text style={styles.text}>
                Task Type<Text style={{color: 'red', marginTop: 10}}>*             </Text>
              </Text>
            </View>
